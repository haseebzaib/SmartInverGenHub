...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(HMI_UART5_TX_GPIO_Port, HMI_UART5_TX_Pin);

    HAL_GPIO_DeInit(HMI_UART5_RX_GPIO_Port, HMI_UART5_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, INVERTER_USART3_TX_Pin|INVERTER_USART3_RX_Pin);
