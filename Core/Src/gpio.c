...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : RelayCont_Pin */
  ...
  /*Configure GPIO pin : alive_led_Pin */
  ...
  /*Configure GPIO pin : Relay_cont_Pin */
